...
import type { QueryInsightsRow, QueryTableProps } from '@/types/monitoring';
...
export default function QueryInsightsQueryLogs() {
    const t = useTranslations('Monitoring');
    const locale = useLocale();
    const filters = useQueryInsightsFiltersValue();
    const [pagination, setPagination] = useQueryInsightsPagination('logs');

    const rowsResult = useQueryInsightsRowsHook(filters, pagination);
